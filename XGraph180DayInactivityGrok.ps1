...
$inactiveUsers30to180 | Export-Csv -Path "XInactiveLicensedUsers_30to180_MgGraph.csv" -NoTypeInformation
...
$inactiveUsers180plus | Export-Csv -Path "XInactiveLicensedUsers_180plus_MgGraph.csv" -NoTypeInformation
